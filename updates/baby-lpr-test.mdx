---
slug: baby-lpr-test
title: Baby Rocket - LPR Test
description: |
  Windy weather has delayed testing the high-power Baby Rocket but has provided a good test for the
  stability of the design using the low power version.
...
We wne to [Midland Rocketry Club](https://midlandrocketryclub.org/) for the June weekend event and Saturday was windy.
