...
structural integrity and precision alignment for the fins. The design uses two
almost identical fincans, one with recovery attachments and one with plumbing for
the staging system.
