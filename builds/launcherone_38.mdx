...
slug: launcherone_38
description: Just lkike the real thing ... but 4" diameter booster and 38mm motor
date: "11-JAN-2024"
project: launcherone
...
<CloudImage image='launcherone/build/cutaway' className='mx-auto' crop='fill' />

The strength of the build is in the fincan and central support structure. The approach I've adopted recently for all of my scratch builds follwos the slotted fin/ centreing ring approach. This allows me to build a very strong structure that is easy to assemble and align. More detals in the [Fincan](fincan) section.
