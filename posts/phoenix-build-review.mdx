...
description: Reflections on building the Phoenix
tags:
  - scale
  - rocket
  - phoenix
...
<CloudImage image='phoenix/build/nosecones'/>

Otherwise, I built the kit largely as intended.

The details for the nosecone fabrication are over in the [build section]('/builds/phoenix-missile/nosecone')
